class ApiConnect {
  static const connectapi = "http://192.168.1.13:8000"; 
  static const connectHost = "$connectapi/api";
  static const connectimage = "$connectapi/foto/product/";

  static const login = "$connectHost/login";
  static const register = "$connectHost/register";
  static const logout = "$connectHost/logout";
  static const me = "$connectHost/me";
  ...
  static const cancel = "$connectHost/cancel";
}
